...
let UiList = class {
  constructor(hostRef) {
    ...
    this.showDetails = index.createEvent(this, "showDetails", 7);
    this.materials = [];
    this.subscribers = [];
  ...
  render() {
    ...
    const items = (_a = this.materials) === null || _a === void 0 ? void 0 : _a.map((material) => {
      ...
      return (index.h("div", { id: this._buildId(material.id), onClick: () => this.selectHandler(material), class: `item-child material-item ${material.isSelected ? 'selected' : ''}` }, index.h("div", { class: "custom-content", innerHTML: itemCustomContent }), index.h("div", { class: "actions" }, index.h("div", { class: "btns" }, index.h("button", { onClick: () => this.showDetailsHandler(material), class: "details" }, "Details"), index.h("button", { onClick: () => {
          this.onDelete(material.id);
        }, class: "delete" }, "Delete")))));
    });
    return index.h("div", { class: "list-con" }, items);
  }
