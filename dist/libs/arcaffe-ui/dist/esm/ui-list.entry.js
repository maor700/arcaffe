import { r as registerInstance, c as createEvent, h, g as getElement } from './index-b2200620.js';
...
class BigmaManagerDB extends Dexie$1 {
  constructor() {
...
const bigmaManagerDb = new BigmaManagerDB();
...
let UiList = class {
  constructor(hostRef) {
    ...
    this.showDetails = createEvent(this, "showDetails", 7);
    this.materials = [];
    this.subscribers = [];
  ...
  render() {
    ...
    const items = (_a = this.materials) === null || _a === void 0 ? void 0 : _a.map((material) => {
      const itemCustomContent = mustache.render(this.itemTemplate, material);
      return (h("div", { id: this._buildId(material.id), onClick: () => this.selectHandler(material), class: `item-child material-item ${material.isSelected ? 'selected' : ''}` }, h("div", { class: "custom-content", innerHTML: itemCustomContent }), h("div", { class: "actions" }, h("div", { class: "btns" }, h("button", { onClick: () => this.showDetailsHandler(material), class: "details" }, "Details"), h("button", { onClick: () => {
...
UiList.style = uiListCss;

export { UiList as ui_list };
